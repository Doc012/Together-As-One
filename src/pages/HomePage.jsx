      ...
      <section id="subscribe" className="bg-blue-50 py-16 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-10">
            {/* <div className="inline-flex items-center justify-center bg-blue-100/50 backdrop-blur-sm p-3 rounded-2xl mb-5">
              <div className="bg-gradient-to-r from-blue-500 to-indigo-600 w-12 h-12 rounded-xl flex items-center justify-center shadow-md">
